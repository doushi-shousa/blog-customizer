...
## 🦅 Комментарии Империума

Код сопровождается дисциплинированными комментариями в стилистике Warhammer 40K.

🛡️ Они размещены только над ключевыми состояниями, эффектами и точками управления.  
⚙️ Логика, архитектура и требования задания остаются неизменными.  
🔥 Комментарии носят атмосферный характер и не влияют на работу приложения.  

📜 Порядок соблюдён. Догматы функциональности не нарушены.
...
```bash
┌──────────────────────────────────────────────────────────┐
│  Imperium Dev Console v1.0                              │
├──────────────────────────────────────────────────────────┤
$ sanctify-project --apply-dogma

> Initializing rites...
> Running lint protocol...
> Verifying architecture seal...
> Scanning for heresy in logic...

Applying sacred styles: ████████████████████ 100%

STATUS: PROJECT STABLE
All systems loyal to the Imperium.
└──────────────────────────────────────────────────────────┘